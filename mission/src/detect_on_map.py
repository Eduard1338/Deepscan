...
if not xyz_files:
    print("Нет файлов дна. Ждём 30 секунд...")
    import time
    time.sleep(30)
    # Рекурсивный перезапуск через перезапуск контейнера
    exit(0)   # выходим с кодом 0, чтобы Docker перезапустил с новым запуском
